...
public class CircuitAnd{

    CircuitAnd(int m, int n){
	...
	DS.pinList.put(a1, new ArrayList<Wire>());
	...
	al.add(new Wire(new Pin(in1,0),new Pin(a1,0)));



	al = DS.pinList.get(in2);
	al.add(new Wire(new Pin(in2,0),new Pin(a1,1)));


	
	al = DS.pinList.get(a1);
	al.add(new Wire(new Pin(a1,0),new Pin(out,0)));
