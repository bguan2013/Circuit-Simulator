...
public class CircuitNor{

    CircuitNor(int m, int n){
	...
	// gates
	Nor nor1 = new Nor("nor1",2,1,true);
	...
	DS.pinList.put(nor1, new ArrayList<Wire>());
	...
	al.add(new Wire(new Pin(in1,0),new Pin(nor1,0)));



	al = DS.pinList.get(in2);
	al.add(new Wire(new Pin(in2,0),new Pin(nor1,1)));


	
	al = DS.pinList.get(nor1);
	al.add(new Wire(new Pin(nor1,0),new Pin(out,0)));
